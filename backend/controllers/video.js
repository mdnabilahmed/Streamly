...
const generateUploadUrl = async (req, res) => {
  try {
    ...
    // Mock user for now if not available in req yet (or ensure auth middleware is used)
    ...
    const s3Key = `videos/${userId}/${uniqueId}_${timestamp}_${sanitizedFileName}.${fileExtension}`;
